...
This project is indexed by GitNexus as **simple-code-gui** (7208 symbols, 12854 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
