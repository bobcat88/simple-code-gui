...
This project is indexed by GitNexus as **simple-code-gui** (6576 symbols, 11635 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
