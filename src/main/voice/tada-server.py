...
# Redirect stderr for clean JSON communication
_stderr = sys.stderr
...
def main():
    ...
    # Apply patches before importing tada
    try:
        import torch
        import soundfile as sf

        # Patch: replace torchaudio.load with soundfile (sox segfaults)
        import torchaudio
    ...
    def load_voice(voice_sample_path):
        ...
        try:
            # If same voice already loaded, skip re-encoding
            ...
            if model is None:
                ...
                # Patch _decode_wav for bf16 -> f32
