...
import { AgentAction, AgentStatus, OrchestrationState, ApprovalRequest } from './types'
...
export function OrchestrationPanel() {
    ...
    const unsubAction = window.api.onAgentAction((action: AgentAction) => {
      setState(prev => {
        ...
        if (action.type === 'approval_request') {
          newState.pendingApprovals = [...prev.pendingApprovals, action as ApprovalRequest]
  ...
  return (
    <div className="orchestration-panel">
      ...
      <ApprovalPanel 
        approvals={state.pendingApprovals as ApprovalRequest[]}
