...
export interface ExtendedApi extends Api {
  ...
  gsdStopPlan: (planId: string) => Promise<string | null>,
  swarmExecuteWave: (projectPath: string, tasks: any[]) => Promise<string>,
  swarmForensicStash: (cwd: string, waveId: string) => Promise<string>,
