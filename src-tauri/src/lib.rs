...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::gsd_engine::gsd_respond_to_approval,
            crate::gsd_engine::gsd_get_personas,
            ...
            gsd_engine::gsd_resolve_consensus,
            gsd_engine::gsd_get_consensus_rounds,
            gsd_engine::gsd_distill_memory,
            ...
            gsd_engine::gsd_propose_policy_refinement,
            gsd_engine::gsd_apply_policy_proposal,
            ...
            gsd_engine::gsd_spawn_shadow_test,
            gsd_engine::gsd_get_persona_proposals,
            gsd_engine::gsd_apply_persona_evolution,
